...
Students = []
class Student:
    # Accept either a CSV row (sequence) or keyword args; preserves previous behavior.
    def __init__(self, row=None, **kwargs):
        if row is not None:
            # existing row-based initialization (safe bounds checks)
            def get(i):
                return row[i] if i < len(row) else None

            self.timestamp = get(0)
            self.email = get(1)
            self.first_name = get(2)
            self.last_name = get(3)
            self.major = get(4)
            self.year = get(5)
            self.project_1 = get(6);  self.project_1_experience = get(7)
            self.project_2 = get(8);  self.project_2_experience = get(9)
            self.project_3 = get(10); self.project_3_experience = get(11)
            self.project_4 = get(12); self.project_4_experience = get(13)
            self.project_5 = get(14); self.project_5_experience = get(15)
            self.project_6 = get(16); self.project_6_experience = get(17)
            self.project_7 = get(18); self.project_7_experience = get(19)
            self.project_8 = get(20); self.project_8_experience = get(21)
            self.electronic_signature = get(22)
            self.resume = get(23)
            self.linkedin = get(24)
        else:
            # kwargs-based initialization (when caller supplies named fields)
            ...
            self.project_1 = kwargs.get('project_1');  self.project_1_experience = kwargs.get('project_1_experience')
            self.project_2 = kwargs.get('project_2');  self.project_2_experience = kwargs.get('project_2_experience')
            self.project_3 = kwargs.get('project_3');  self.project_3_experience = kwargs.get('project_3_experience')
            self.project_4 = kwargs.get('project_4');  self.project_4_experience = kwargs.get('project_4_experience')
            self.project_5 = kwargs.get('project_5');  self.project_5_experience = kwargs.get('project_5_experience')
            self.project_6 = kwargs.get('project_6');  self.project_6_experience = kwargs.get('project_6_experience')
            self.project_7 = kwargs.get('project_7');  self.project_7_experience = kwargs.get('project_7_experience')
            self.project_8 = kwargs.get('project_8');  self.project_8_experience = kwargs.get('project_8_experience')
            self.electronic_signature = kwargs.get('electronic_signature')
